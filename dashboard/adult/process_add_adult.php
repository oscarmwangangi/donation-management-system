            ...
            <div class='modal-dialog' role='document'>
                <div class='modal-content'>
                    ...
                    <div class='modal-footer'>
                        <button type='button' class='btn btn-primary' onclick=\"window.location.href='" . ($redirect ? 'view_adults.php' : 'javascript:history.back()') . "';\">OK</button>
                    </div>
                </div>
            </div>
        </div>
...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $sql = "INSERT INTO adult (first_name, last_name, county, village, date_enrolled, court_commital, contact, name_of_child_officer_involved, name_of_father, name_of_mother)
            VALUES ('$first_name', '$last_name', '$county', '$village', '$date_enrolled', '$court_commital', '$contact', '$name_of_father', '$name_of_mother', '$name_of_child_officer_involved')";
