...
<body>
    <div class="container">
        ...
        <div class="content row">
            <div class="col-md-6 mb-4">
                <div class="button-container">
                    <a href="add_child.php" class="btn btn-purple btn-lg">
                        <i class="fas fa-child"></i> Add New Child Record
                    </a>
                </div>
            </div>
            <div class="col-md-6 mb-4">
                <div class="button-container">
                    <a href="view_children.php" class="btn btn-info btn-lg">
        ...
        <!-- <div class="image">
            <img src="../../sql/akina.jpg" alt="Children Image">
        </div> -->
    </div>
