...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $sql = "INSERT INTO person (first_name, last_name, county, village, date_enrolled, court_commital, contact, name_of_child_officer_involved, name_of_father, name_of_mother)
            VALUES ('$first_name', '$last_name', '$county', '$village', '$date_enrolled', '$court_commital', '$contact', '$name_of_child_officer_involved', '$name_of_father', '$name_of_mother')";
