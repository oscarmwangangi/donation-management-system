...
<html>
<head>
    <title>Update Child Record</title>
...
<body>
    <div class="container">
        ...
        } else if ($_SERVER["REQUEST_METHOD"] == "POST" && isset($_POST['child_id'])) {
            ...
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    ...
                    <div class="modal-footer">
                        <a href="view_children.php" class="btn btn-primary">OK</a>
                    </div>
                </div>
            </div>
        </div>
