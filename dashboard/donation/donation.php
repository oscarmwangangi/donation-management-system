...
<body>
    <div class="container">
        <h1>Donation Managment</h1>
            <div class="content row">
                <div class="col-md-6 mb-4">
                    <div class="button-container">
                        <a href="./add_money/index.html" class="btn btn-purple btn-lg">
                            <i class="fas fa-child"></i> Money Donation
                        </a>
                    </div>
                </div>
                <div class="col-md-6 mb-4">
                    <div class="button-container">
                        <a href="item_donation.php" class="btn btn-info btn-lg">
                            <i class="fas fa-eye"></i> Item Donation
                        </a>
                    </div>
                </div>
