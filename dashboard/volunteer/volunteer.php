        ...
        <div class="content row">
            <div class="col-md-6 mb-4">
                 <div class="button-container">
                    <a href="add_volunteer.php" class="btn btn-purple btn-lg">
                        <i class="fas fa-user-plus"></i> Add New Volunteer Record
                    </a>
                    </div>
                </div>
             ...
             <div class="col-md-6 mb-4">
                 <div class="button-container">
                    <a href="view_volunteers.php" class="btn btn-info btn-lg">
